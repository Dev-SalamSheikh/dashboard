...
import { Stakced, Pie, Button, SparkLine } from "../components";
import {
  earningData,
  SparklineAreaData,
  ecomPieChartData,
  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 m-3 p-4 rounded-2xl md:w-77">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-bold">$90,432</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-bold">$120, 432</span>
                </p>
                <p className="text-gray-500 mt-1">Budget</p>
              </div>
